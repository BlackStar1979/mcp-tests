...
- Workflow progress markers: `current_working_course = memory-embedding-runtime-activation-gate`; `next_primary = mem-1-live-provider-activation-and-quality-proof`; `next_secondary = descriptor-refresh-impact-review`.
