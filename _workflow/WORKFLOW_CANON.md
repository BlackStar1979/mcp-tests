...
- Workflow progress markers: `current_working_course = post_53d-initialize-compatibility-debug-and-retirement-scope`; `next_primary = post_53d-real-client-entry-evidence-refresh`; `next_secondary = post_53d-decision-relevant-connector-visible-surface-revalidation`.
