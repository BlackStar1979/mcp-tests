...
- Workflow progress markers: `current_working_course = post_53d-initialize-compatibility-debug-and-retirement-scope`; `next_primary = post_53d-doc-2a-diagnostics-orientation`; `next_secondary = post_53d-real-client-entry-evidence-refresh`.
