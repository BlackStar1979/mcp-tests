...
- Workflow progress markers: `current_working_course = protocol-compatibility-evidence`; `next_primary = comp-1a-client-entry-evidence-on-new-version`; `next_secondary = ops-1b-live-sftp-and-reauth-evidence-when-available`.
