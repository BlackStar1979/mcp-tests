...
- Current live OAuth21 runtime and connector count: `84`; the hardened CBM v0.9.0 contract, including stdin native transport, normalized change results, partial-result metadata, semantic-only suppression, source-bearing excluded-route warnings, repaired ADR storage, and `state_handle` confirmation, is live at `server_start_id = 2026-07-28T04:54:53.586Z` with unchanged connector-visible surface. No connector refresh remains pending.
