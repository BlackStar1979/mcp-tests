...
function buildHarnessResult() {
  ...
  assert.equal(toolCount, 68);
  assert.equal(serverSpec.server.authenticated_tool_count, 68);
  assert.equal(connectorSpec.authenticated_connector.repo_current_expected_tool_count, 68);
