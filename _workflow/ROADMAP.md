...
- The hardened CBM v0.9.0 runtime is live at `server_start_id = 2026-07-29T18:00:39.162Z` with `84` tools, fifteen `cbm_*` tools, unchanged connector-visible surface, and verified snippet source-integrity recovery.
