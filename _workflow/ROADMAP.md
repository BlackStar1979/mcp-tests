...
Completed observability acceptance: `OBS-1-LIVE-TRAIL` proves that bounded current-window and retained-window evidence answers live client-entry questions without broader logging; it also makes report filters fail closed and supports both standard CLI value forms.
