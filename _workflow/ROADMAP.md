...
0. `POL-1A-DLP` — runtime live accepted, connector refresh/review pending
   Final source commit `b385c88` is live on OAuth21 `3008` at `server_start_id = 2026-08-18T04:39:45.722Z`; health, durable process recovery, live `read_file`, DLP regression coverage, and the `98`-tool runtime fingerprint `93721a82a339f9d6` are green. The connector/model cache still carries the prior schema fingerprint `ec7d3af5b4ea17f5`, so refresh/review the authenticated connector before clearing the surface-drift marker.
