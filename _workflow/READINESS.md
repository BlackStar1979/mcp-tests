...
- Live identity: `server_start_id = 2026-07-28T04:54:53.586Z`, 84 authenticated tools, unchanged connector-visible surface.
...
- `2026-07-28`: live-loaded CBM partial-result metadata on OAuth21 `3008` at `server_start_id = 2026-07-28T04:54:53.586Z`. `detect_changes` now exposes returned/omitted totals, `bridge_analysis`, and `impact_resolution_reason`; `ingest_traces` exposes `runtime_edge_creation` and `runtime_edges_created`; semantic-only `search_graph` suppression and source-bearing excluded-route warnings are live. Live probes confirm the new fields; no connector refresh was required.
