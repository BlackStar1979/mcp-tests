...
Current repo/runtime note: profile `tests`; live OAuth21 `3008` has source commit `f2a574b28bed53b32093d23d0bd06321e58c4b8c` loaded at `server_start_id = 2026-08-17T15:20:52.127Z`, while repository head `49fb569` adds workflow-only acceptance evidence. The runtime exposes `98` connector-visible tools with fingerprint `ec7d3af5b4ea17f5`. `MCP-TASKS-PROCESS-ADAPTER` (`7 + 294`), `TRACE-CONTEXT` (`7 + 298`), `PROCESS-ARTIFACTS` (`7 + 301`), `CIMD` (`7 + 304`), and `DEBT-1-RETIREMENT` (`7 + 305`) are live-loaded and live-accepted. `MRTR` remains fixture-only conformance evidence at `7 + 305`; runtime loading is not applicable because it has no production runtime surface.
