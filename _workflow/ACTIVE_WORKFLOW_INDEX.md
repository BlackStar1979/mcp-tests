...
- authorized runtime: `auth:oauth21`, port `3008`, current live and repository surface 84 connector-visible tools at `server_start_id = 2026-07-28T16:05:12.562Z`; current `COMP-1A` evidence remains the earlier July 27 `initialize_only` window for `openai-mcp 1.0.0`;
