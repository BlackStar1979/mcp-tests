...
S10B passed the live authenticated sessionless probe on OAuth21 3008. `/mcp/sessionless` is active and validated as the new workbench/sessionless target for controlled repo-native probing. This does not migrate the connector route and does not change connector-visible truth.
