...
const CONFIG = {
  ...
  "_workflow/operator_decisions": {
    ...
    entries: {
      ...
      "pol_1a_authorization_reconciliation_live_closeout.md": "Live acceptance evidence for capability-adaptive operator authorization: standing bounded OAuth authorization, explicit fresh-consent selection, direct ChatGPT process/workspace callability, preserved runner guards, and unchanged connector surface.",
