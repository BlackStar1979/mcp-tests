...
const VALID_DATABASE_SCOPES = new Set(["state_store", "memory_store", "network_cache_store", "plugin_visibility_store", "audit_receipt_store", "operator_config_store", "schema_migration_store", "process_job_registry", "content_stage_store", "file_compose_journal"]);
...
const VALID_RESOURCE_POLICY_REFS = new Set(["public_index", "filesystem_public", "filesystem_workspace_readonly", "filesystem_workspace_mutation", "filesystem_workspace_structured_readonly", "filesystem_workspace_structured_mutation", "network_allowlisted", "memory_context_scoped", "plugin_registry_readonly", "plugin_visibility_state_preview", "plugin_execution_readonly", "auth_runtime_readonly", "observability_audit_readonly", "tool_surface_planning", "runtime_tool_registry_readonly", "workspace_index_readonly", "workspace_index_mutation", "codebase_memory_readonly", "codebase_memory_mutation", "codebase_memory_destructive", "runtime_status_readonly", "process_execution_bounded", "process_job_registry_readonly", "process_job_control", "database_store_bounded", "remote_site_readonly", "remote_site_mutation"]);
