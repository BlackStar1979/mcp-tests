...
const VALID_DATABASE_SCOPES = new Set(["state_store", "memory_store", "network_cache_store", "plugin_visibility_store", "audit_receipt_store", "operator_config_store", "schema_migration_store", "process_job_registry"]);
