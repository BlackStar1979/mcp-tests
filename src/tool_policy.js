...
const TOOL_POLICIES = Object.freeze({
  ...
  content_stage: policy({ profileAllowed: ["internal"], readOnly: false, destructive: true, usesFs: true, fsScope: "content-stage-store", authRequired: true, publicSafe: false }),
  file_transform: policy({ profileAllowed: ["internal"], readOnly: false, destructive: true, usesFs: true, fsScope: "workspace-structured-mutation", authRequired: true, publicSafe: false, workspaceFs: true }),
  file_split: policy({ profileAllowed: ["internal"], readOnly: false, destructive: true, usesFs: true, fsScope: "workspace-structured-mutation", authRequired: true, publicSafe: false, workspaceFs: true }),
  file_merge: policy({ profileAllowed: ["internal"], readOnly: false, destructive: true, usesFs: true, fsScope: "workspace-structured-mutation", authRequired: true, publicSafe: false, workspaceFs: true }),
  ...
  markdown_transform: policy({ profileAllowed: ["internal"], readOnly: false, destructive: true, usesFs: true, fsScope: "workspace-structured-mutation", authRequired: true, publicSafe: false, workspaceFs: true }),
