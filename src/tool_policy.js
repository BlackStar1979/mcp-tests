...
const TOOL_POLICIES = Object.freeze({
  ...
  memory_save:        policy({ profileAllowed: ["internal"], authRequired: true, publicSafe: false, usesFs: true, fsScope: "agent-memory-store", readOnly: false, openWorld: true, usesNetwork: true }),
  memory_search:      policy({ profileAllowed: ["internal"], authRequired: true, publicSafe: false, usesFs: true, fsScope: "agent-memory-store", openWorld: true, usesNetwork: true }),
  ...
  cbm_status: policy({ profileAllowed: ["internal"], authRequired: true, publicSafe: false, usesFs: true, fsScope: "codebase-memory-readonly" }),
  cbm_list_projects: policy({ profileAllowed: ["internal"], authRequired: true, publicSafe: false, usesFs: true, fsScope: "codebase-memory-readonly" }),
  cbm_index_repository: policy({ profileAllowed: ["internal"], authRequired: true, publicSafe: false, readOnly: false, destructive: false, usesFs: true, fsScope: "codebase-memory-index-mutation" }),
  cbm_get_architecture: policy({ profileAllowed: ["internal"], authRequired: true, publicSafe: false, usesFs: true, fsScope: "codebase-memory-readonly" }),
  cbm_search_graph: policy({ profileAllowed: ["internal"], authRequired: true, publicSafe: false, usesFs: true, fsScope: "codebase-memory-readonly" }),
  cbm_query_graph: policy({ profileAllowed: ["internal"], authRequired: true, publicSafe: false, usesFs: true, fsScope: "codebase-memory-readonly" }),
  cbm_trace_path: policy({ profileAllowed: ["internal"], authRequired: true, publicSafe: false, usesFs: true, fsScope: "codebase-memory-readonly" }),
  ...
  cbm_ingest_traces: policy({ profileAllowed: ["internal"], authRequired: true, publicSafe: false, readOnly: false, destructive: false, usesFs: true, fsScope: "codebase-memory-mutation" }),
  ...
  file_inspect: policy({ profileAllowed: ["internal"], usesFs: true, fsScope: "workspace-structured-readonly", authRequired: true, publicSafe: false, workspaceFs: true }),
  content_stage: policy({ profileAllowed: ["internal"], readOnly: false, destructive: false, usesFs: true, fsScope: "content-stage-store", authRequired: true, publicSafe: false }),
  file_transform: policy({ profileAllowed: ["internal"], readOnly: false, destructive: false, usesFs: true, fsScope: "workspace-structured-mutation", authRequired: true, publicSafe: false, workspaceFs: true }),
  file_split: policy({ profileAllowed: ["internal"], readOnly: false, destructive: false, usesFs: true, fsScope: "workspace-structured-mutation", authRequired: true, publicSafe: false, workspaceFs: true }),
  file_merge: policy({ profileAllowed: ["internal"], readOnly: false, destructive: false, usesFs: true, fsScope: "workspace-structured-mutation", authRequired: true, publicSafe: false, workspaceFs: true }),
  markdown_inspect: policy({ profileAllowed: ["internal"], usesFs: true, fsScope: "workspace-structured-readonly", authRequired: true, publicSafe: false, workspaceFs: true }),
  markdown_transform: policy({ profileAllowed: ["internal"], readOnly: false, destructive: false, usesFs: true, fsScope: "workspace-structured-mutation", authRequired: true, publicSafe: false, workspaceFs: true }),
  ...
  fits_info: policy({ usesFs: true, fsScope: "workspace-readonly-roots", publicSafe: false }),
  hdf5_info: policy({ usesFs: true, fsScope: "workspace-readonly-roots", publicSafe: false }),
  inventory_tree: policy({ usesFs: true, fsScope: "workspace-readonly-roots", publicSafe: false }),
  table_profile: policy({ usesFs: true, fsScope: "workspace-readonly-roots", publicSafe: false }),
  list_remote_site_files: policy({ usesFs: true, usesNetwork: true, openWorld: true, fsScope: "remote-site-config-ref-readonly", publicSafe: false, authRequired: true }),
  read_remote_site_file: policy({ usesFs: true, usesNetwork: true, openWorld: true, fsScope: "remote-site-config-ref-readonly", publicSafe: false, authRequired: true }),
  remote_site_runtime_status: policy({ usesFs: true, usesNetwork: true, openWorld: true, fsScope: "remote-site-config-ref-readonly", publicSafe: false, authRequired: true }),
  preview_remote_site_retention: policy({ usesFs: true, usesNetwork: true, openWorld: true, fsScope: "remote-site-config-ref-readonly", publicSafe: false, authRequired: true }),
  write_remote_site_file: policy({ profileAllowed: ["internal"], readOnly: false, destructive: true, usesFs: true, usesNetwork: true, openWorld: true, fsScope: "remote-site-config-ref-write", publicSafe: false, authRequired: true }),
  edit_remote_site_file: policy({ profileAllowed: ["internal"], readOnly: false, destructive: true, usesFs: true, usesNetwork: true, openWorld: true, fsScope: "remote-site-config-ref-write", publicSafe: false, authRequired: true }),
  delete_remote_site_file: policy({ profileAllowed: ["internal"], readOnly: false, destructive: true, usesFs: true, usesNetwork: true, openWorld: true, fsScope: "remote-site-config-ref-write", publicSafe: false, authRequired: true }),
  move_remote_site_file: policy({ profileAllowed: ["internal"], readOnly: false, destructive: true, usesFs: true, usesNetwork: true, openWorld: true, fsScope: "remote-site-config-ref-write", publicSafe: false, authRequired: true }),
  restore_remote_site_file: policy({ profileAllowed: ["internal"], readOnly: false, destructive: true, usesFs: true, usesNetwork: true, openWorld: true, fsScope: "remote-site-config-ref-write", publicSafe: false, authRequired: true }),
  ...
  code_orchestrate: policy({ usesFs: true, fsScope: "workspace-code-inspection" }),
  ...
  code_apply_patch: policy({ profileAllowed: ["internal"], readOnly: false, destructive: false, usesFs: true, fsScope: "workspace-write-roots", authRequired: true, publicSafe: false, workspaceFs: true }),
  code_rollback_patch: policy({ profileAllowed: ["internal"], readOnly: false, destructive: false, usesFs: true, fsScope: "workspace-write-roots", authRequired: true, publicSafe: false, workspaceFs: true }),
  tool_dispatch: policy({ profileAllowed: ["internal"], readOnly: false, destructive: false, usesFs: true, fsScope: "workspace-write-roots", authRequired: true, publicSafe: false, workspaceFs: true }),
