...
- `network_policy.js`, `path_policy.js`, `process_runner.js`, `process_runner_config.js`, `process_execution.js`, `process_job_manager.js`
  Shared runtime policy, pinned command resolution, process execution, and asynchronous job lifecycle helpers.
