...
const processStartTool = {
  ...
  descriptor: {
    ...
    description: "Validate and enqueue an allowlisted workspace process, returning immediately with a bounded OAuth-client-bound in-memory job handle.",
  ...
  execute(args = {}, context = {}) {
    return resolveProcessJobManager(context).start(args, {
