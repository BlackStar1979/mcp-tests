...
- Active manifest counts:
  - `7` public scripts
- `225` total active scripts currently listed in `run_all_smoke_scripts.json`
- `217` authenticated scripts confirmed green by the latest `--skip-network` full run
...
- The active manifest currently contains `225` scripts.
