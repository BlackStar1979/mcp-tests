...
- Active manifest counts:
  ...
  - `216` authenticated scripts confirmed green by the latest `--skip-network` full run
...
- The latest confirmed `--skip-network` full run validates `7` public scripts and `216` authenticated scripts.
