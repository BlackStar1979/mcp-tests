...
(() => {
  ...
  assertMatrix("authorized", authMatrix, { total: 84, required: ["memory_save", "search_index", "build_index", "write_file", "run_process", "code_patch_plan", "code_scenario", "write_remote_site_file", "restore_remote_site_file", "code_orchestrate", "code_apply_patch", "code_rollback_patch", "tool_dispatch", "cbm_status", "cbm_index_repository"] });
