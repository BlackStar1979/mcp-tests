...
(() => {
  ...
  assertMatrix("authorized", authMatrix, { total: 98, required: ["memory_save", "memory_update_task", "search_index", "build_index", "write_file", "file_transform", "file_split", "file_merge", "markdown_transform", "run_process", "process_start", "process_status", "process_output", "process_cancel", "process_list", "process_events", "code_patch_plan", "code_scenario", "write_remote_site_file", "restore_remote_site_file", "code_orchestrate", "code_apply_patch", "code_rollback_patch", "tool_dispatch", "cbm_status", "cbm_index_repository"] });
  ...
  console.log("smoke_policy_enforcement_coverage_matrix ok");
})();
