...
assert.equal(state.workflow_progress_markers.next_secondary, "oauth21-safe-recurring-prune-redesign");
...
assert.ok(index.includes("`next_secondary = oauth21-safe-recurring-prune-redesign`"));
...
assert.ok(canon.includes("`next_secondary = oauth21-safe-recurring-prune-redesign`"));
