...
assert.equal(state.workflow_progress_markers.next_secondary, "mem-1-secret-file-activation-package");
...
assert.ok(index.includes("`next_secondary = mem-1-secret-file-activation-package`"));
...
assert.ok(canon.includes("`next_secondary = mem-1-secret-file-activation-package`"));
