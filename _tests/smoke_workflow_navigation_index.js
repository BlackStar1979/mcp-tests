...
assert.equal(state.workflow_progress_markers.next_secondary, "post_53d-decision-relevant-connector-visible-surface-revalidation");
assert.ok(index.includes("`next_primary = post_53d-real-client-entry-evidence-refresh`"));
assert.ok(index.includes("`next_secondary = post_53d-decision-relevant-connector-visible-surface-revalidation`"));
assert.ok(canon.includes("`next_primary = post_53d-real-client-entry-evidence-refresh`"));
assert.ok(canon.includes("`next_secondary = post_53d-decision-relevant-connector-visible-surface-revalidation`"));
