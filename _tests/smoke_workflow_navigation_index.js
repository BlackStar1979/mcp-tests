...
assert.equal(state.workflow_progress_markers.next_secondary, "mem-1-runtime-config-presence-audit");
...
assert.ok(index.includes("`next_secondary = mem-1-runtime-config-presence-audit`"));
...
assert.ok(canon.includes("`next_secondary = mem-1-runtime-config-presence-audit`"));
