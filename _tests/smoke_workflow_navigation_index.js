...
assert.equal(state.workflow_progress_markers.next_secondary, "comp-1b-after-material-comp-1a-change");
...
assert.ok(canon.includes("`next_secondary = comp-1b-after-material-comp-1a-change`"));
