...
assert.equal(state.workflow_progress_markers.next_secondary, "descriptor-refresh-impact-review");
...
assert.ok(index.includes("`next_secondary = descriptor-refresh-impact-review`"));
...
assert.ok(canon.includes("`next_secondary = descriptor-refresh-impact-review`"));
