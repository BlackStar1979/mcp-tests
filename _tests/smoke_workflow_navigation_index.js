...
assert.equal(state.workflow_progress_markers.next_primary, "pol-1a-mrtr-runtime");
...
assert.ok(index.includes("`next_primary = pol-1a-mrtr-runtime`"));
...
assert.ok(canon.includes("`next_primary = pol-1a-mrtr-runtime`"));
