...
assert.ok(index.includes("`MCP-TASKS-PROCESS-ADAPTER` is repo-validated on clean history"));
assert.ok(index.includes("has not been loaded into runtime `3008`"));
assert.ok(index.includes("No runtime restart, connector refresh, or OAuth relogin was performed for the Tasks package"));
