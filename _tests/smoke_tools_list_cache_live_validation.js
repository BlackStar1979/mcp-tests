...
const expectedCurrentStatus = "live_authenticated_tools_list_95_repo_expected_95_connector_ui_visibility_unverified";
const expectedCurrentFingerprint = "7c7279dd8508e37a";
const expectedCurrentHash = "af4d2ceb3b657566";
...
assert.ok(index.includes("live authenticated runtime + `tools/list` now confirms 95 tools"));
...
assert.ok(canon.includes("Live OAuth21 `3008` is aligned with the authenticated `/mcp` tool count `95`"));
