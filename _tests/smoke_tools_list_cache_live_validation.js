...
assert.equal(c.repo_current_expected_tool_count, 85);
...
assert.ok(index.includes("current live and repository surface 85 connector-visible tools"));
...
assert.ok(index.includes("The v3 knowledge index contains `262` documents"));
