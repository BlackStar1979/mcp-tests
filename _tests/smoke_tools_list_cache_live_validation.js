...
const expectedCurrentStatus = "repo_ahead_live_authenticated_tools_list_53_expected_69_restart_required_connector_ui_visibility_unverified";
...
assert.ok(index.includes("repo truth now expects `69` authenticated tools"));
...
assert.ok(canon.includes("Repo current authenticated tool target after modular safe-tool surface consolidation: `69`"));
