...
- `358` JavaScript files total in `_tests`
- `275` active scripts currently listed in `run_all_smoke_scripts.json`
...
- last confirmed section counts from that full run: `7` public scripts and `267` authenticated scripts
