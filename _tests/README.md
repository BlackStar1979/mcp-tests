...
- `378` JavaScript files total in `_tests`
- `294` active scripts currently listed in `run_all_smoke_scripts.json`
...
- current manifest file contains `294` entries, including `_tests/smoke_network.js`; `--skip-network` therefore validates `293` sectioned scripts, not all `294` manifest entries
