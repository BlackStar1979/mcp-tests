...
- `372` JavaScript files total in `_tests`
- `288` active scripts currently listed in `run_all_smoke_scripts.json`
...
- current manifest file contains `288` entries, including `_tests/smoke_network.js`; `--skip-network` therefore validates `287` sectioned scripts, not all `288` manifest entries
