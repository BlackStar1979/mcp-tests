...
const dryRunHarness = runListChangedHarness({
  ...
  allowEmit: false,
  reason: "stage8_37 dry run",
  correlationId: "stage8_37_dry",
});
...
const futureHarness = runListChangedHarness({
  ...
  allowEmit: true,
  reason: "stage8_37 future mock",
  correlationId: "stage8_37_future",
});
...
console.log("smoke_stage8_37_list_changed_audit_receipt ok");
