...
assert.equal(net.internal_service_egress.memory_embeddings.endpoint,"https://oai.endpoints.kepler.ai.cloud.ovh.net/v1/embeddings");
assert.equal(net.internal_service_egress.memory_embeddings.default_enabled,false);
assert.equal(net.internal_service_egress.memory_embeddings.server_owned_auth_only,true);
assert.equal(net.internal_service_egress.memory_embeddings.timeout_ms,5000);
assert.equal(net.internal_service_egress.memory_embeddings.max_response_bytes,262144);
