...
assert.ok(plan.blockers.includes("observability_status output schema must not be changed in Stage 8 / Step 43"));
...
console.log("smoke_stage8_43_audit_redaction_integration_plan ok");
