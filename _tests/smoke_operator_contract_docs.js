...
assert.ok(stateDoc.includes("tests_authenticated=265"));
assert.ok(stateDoc.includes("Latest validated authenticated smoke count: `265`"));
...
assert.ok(roadmap.includes("Completed repair chain: `CBM-ADR-REPAIR`, `OAUTH-DUPLICATE-HELPER-REVIEW`, and `FINAL-LIVE-LOAD`"));
