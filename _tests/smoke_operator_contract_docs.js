...
assert.ok(stateDoc.includes("tests_authenticated=280"));
assert.ok(stateDoc.includes("Latest validated authenticated smoke count: `280`"));
...
assert.ok(readiness.includes("Repository and live OAuth21 runtime align at `13 + 78 = 91`"));
