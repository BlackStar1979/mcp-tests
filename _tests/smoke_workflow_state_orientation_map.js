...
assert.equal(state.tool_surfaces.authorized_mcp_tools.count, 78);
assert.equal(state.tool_surfaces.authenticated_total.count, 91);
...
assert.equal(state.current_work_constraints.test_processes_use_hermetic_control_paths, true);
