...
assert.ok(record.includes("bounded dual recognition of legacy `initialize` and modern `server/discover`"));
assert.ok(record.includes("does not change the target architecture above"));
