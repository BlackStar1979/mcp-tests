...
assert.equal(tools.total_mcp_callable_tool_count, 68);
assert.equal(rootSpec.server.full_tests_authenticated_tool_count, 68);
assert.equal(connector.authenticated_connector.expected_public_plus_authorized_count, 68);
