...
//
// Proves the positive baseline smoke (smoke_stage9_baseline_manifest.js) fails
...
const POSITIVE_SMOKE = path.join(__dirname, "smoke_stage9_baseline_manifest.js");
...
console.log("smoke_stage9_baseline_drift_guard ok");
